...
<body> 
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
      <a class="nav-link" href="pagrindinis.php">Apie mus</a>
      </li>

      <li class="nav-item">
      <a class="nav-link" href="pagrindinis.php">Eparduotuve@Adalys.lt</a>
      </li>
...
<header>
  ...
  <div class="fotke">
      ...
      <br><h2 class="centras">Sveiki atvykę į</h2>
    ...
    <main>
       <br>
        ...
        <center><div class="foto1" style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;">
            <h1> Sportiniai stabdžių diskai </h1>
        <img src="img/1.png" ; width="25%" ; height="45%";>
            <br>
            <br>
            <a href="katalogas.php"><button class="btn btn-primary"> Pirkti </button></a>
            </div></center>
            <br>
        ...
        <img src="img/2.jpg" ; width="25%" ; height="45%";>
            ...
            <br>
        <center><div class="foto3" style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;">
            <h1> Turbokompresorius </h1>
        <img src="img/3.jpg" ; width="25%" ; height="45%";>
            <br>
            <br>
            <a href="katalogas.php"><button class="btn btn-primary"> Pirkti </button></a>
            </div></center>
            <br>
        <center><div class="foto4" style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;">
            <h1> Sportinis vairas </h1>
        <img src="img/4.jpg" ; width="25%" ; height="45%";>
            <br>
            <br>
            <a href="katalogas.php"><button class="btn btn-primary"> Pirkti </button></a>
            </div></center>
